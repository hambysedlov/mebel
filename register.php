<?php require_once ("templates/top.php"); ?>
	...
	<div class="content">
		<div class="typography">
			...
			if(isset($_POST['name'])&&isset($_POST['surname'])&&isset($_POST['email'])&&isset($_POST['password'])&&$_POST['name']!=""&&$_POST['name']!=""&&$_POST['surname']!=""&&$_POST['password']!=""&&stristr($_POST['name'], '"') === FALSE&&stristr($_POST['surname'], '"') === FALSE&&stristr($_POST['email'], '"') === FALSE&&stristr($_POST['password'], '"') === FALSE){ 
			...
			if((!isset($_POST['name'])&&!isset($_POST['surname'])&&!isset($_POST['email'])&&!isset($_POST['password']))||$_POST['name']==""||$_POST['name']==""||$_POST['surname']==""||$_POST['password']==""){
			?>
			
            <p style="font-weight: bold;text-align: center; font-size:19px;">Вы не заполнили какое-то поле, попробуйте ещё раз</p>
